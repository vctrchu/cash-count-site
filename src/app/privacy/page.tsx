    ...
    <article className="mx-auto max-w-2xl px-6 py-16">
      ...
      <div className="space-y-10 text-sm leading-relaxed text-[#999]">
        ...
        <section>
          ...
          <h3 className="mb-2 text-sm font-semibold text-white">RevenueCat</h3>
          <p className="mb-3">
            We use{" "}
            <a href="https://www.revenuecat.com" className="text-accent underline underline-offset-2" target="_blank" rel="noopener noreferrer">
              RevenueCat
            </a>{" "}
            to manage in-app subscriptions. When you make a purchase, RevenueCat processes the
            transaction and may collect:
          </p>
          <ul className="mb-4 list-none space-y-1 border-l-2 border-border pl-4">
          ...
          <p className="mb-6">
            ...
            more details, see{" "}
            <a href="https://www.revenuecat.com/privacy/" className="text-accent underline underline-offset-2" target="_blank" rel="noopener noreferrer">
              RevenueCat&apos;s Privacy Policy
            </a>
            .
          </p>

          <h3 className="mb-2 text-sm font-semibold text-white">Apple App Store</h3>
          <p>
            Purchases are processed by Apple. Apple&apos;s handling of your payment information is
            governed by{" "}
            <a href="https://www.apple.com/privacy/" className="text-accent underline underline-offset-2" target="_blank" rel="noopener noreferrer">
        ...
        <section>
          <h2 className="mb-3 text-base font-semibold text-white">4. Data Storage and Security</h2>
          <p className="mb-3">
        ...
        <section>
          <h2 className="mb-3 text-base font-semibold text-white">5. Children&apos;s Privacy</h2>
          <p>
        ...
        <section>
          <h2 className="mb-3 text-base font-semibold text-white">6. Changes to This Policy</h2>
          <p>
